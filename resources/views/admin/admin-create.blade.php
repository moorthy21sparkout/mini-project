...
<body class="bg-gray-100 p-4">
    <div class="max-w-md mx-auto bg-white rounded p-6 shadow-xl">
        ...
        <form action="{{ route('admin-store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label for="datetime_field" class="block text-sm font-medium text-gray-700"> End-Datetime</label>
            ...
            <div class="mb-4">
                ...
                <select name="status" id="status"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm  px-3 py-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm text-black">
